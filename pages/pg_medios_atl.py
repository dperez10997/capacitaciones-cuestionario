# pages/pg_medios_atl.py — ATL (iframe YouTube dentro de caja 16:9, 12cm de ancho)
import re
import streamlit as st
from ui_style import boot_css, render_banner

st.set_page_config(page_title="Medios ATL — Capacitaciones eSP", page_icon="🎓", layout="wide")
boot_css()
render_banner("Medios ATL")
...
st.caption("Conceptos y procesos para planificación ATL: plan de medios, OCs y manejo multimoneda.")


video_block("08 — Creación Orden de Compra Medios", "https://www.youtube.com/watch?v=yqLbndLvrQE&t=32s")
video_block("09 — Plan de Medios", "https://www.youtube.com/watch?v=vIyziz-SPoM&t=34s")
video_block("10 — Multimoneda", "http://youtube.com/watch?v=S54C0dNMfs0")
