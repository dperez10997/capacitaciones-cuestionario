...
# -*- coding: utf-8 -*-
"""
Cuestionario de Capacitación (PLAIN)
- Sin formato/tema personalizado (usa el estilo por defecto de Streamlit).
...
- Panel de administración con PIN, métricas y exportaciones CSV.
"""
